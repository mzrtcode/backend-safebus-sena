...
router.put('/localidades/:id', autenticacionRequerida, actualizarLocalidad) // Ruta para actualizar una localidad por su ID. Llama al controlador de actualización de localidad.
router.delete('/localidades/:id', autenticacionRequerida, eliminarLocalidad) // Ruta para eliminar una localidad por su ID. Llama al controlador de eliminación de localidad.
