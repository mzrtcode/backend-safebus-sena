...
router.get('/propietarios/:id', obtenerPropietario)
router.post(
  '/propietarios',
...
router.put('/propietarios/:id', actualizarPropietario) // Ruta para actualizar una localidad por su ID. Llama al controlador de actualización de localidad.
router.delete('/propietarios/:id', eliminarPropietario) // Ruta para eliminar una localidad por su ID. Llama al controlador de eliminación de localidad. */
